...
export const DEFAULT_THEMES = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/9038e3-YOUR-INSTANCEID-HERE`,
      },
      {
      ...
      {
        name: 'ndvi_global_300m_daily_v3',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
      ...
      },
      {
        ...
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/e1499e-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'dmp_global_300m_10daily_v2_rt1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/042c01-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'dmp_global_300m_10daily_v2_rt2',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/a1a212-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'dmp_global_300m_10daily_v2_rt6',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/895940-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gpp_global_300m_10daily_v2_rt0',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/e1f382-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gpp_global_300m_10daily_v2_rt1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/37afc8-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gpp_global_300m_10daily_v2_rt2',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/52aa9b-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gpp_global_300m_10daily_v2_rt6',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/0e9c96-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'npp_global_300m_10daily_v2_rt0',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/04c715-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'npp_global_300m_10daily_v2_rt1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/804e62-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'npp_global_300m_10daily_v2_rt2',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/84552a-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'npp_global_300m_10daily_v2_rt6',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/730752-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gdmp_global_300m_10daily_v2_rt0',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/9c0c63-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gdmp_global_300m_10daily_v2_rt1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/d24515-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gdmp_global_300m_10daily_v2_rt2',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/b5314a-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'gdmp_global_300m_10daily_v2_rt6',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
      ...
      },
      {
        ...
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/0e1196-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'clms_vlcc_coniferous-cover-density_europe_100m_yearly_v1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/ed175f-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'clms_vlcc_forest-type_europe_100m_3yearly_v1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/86e613-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'clms_vlcc_grassland_europe_100m_yearly_v1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/3cea8f-YOUR-INSTANCEID-HERE`,
      },
      {
        name: 'clms_vlcc_tree-cover-density_europe_100m_yearly_v1',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
    ...
    pins: [
      {
        ...
        lng: -122.38866,
        zoom: 13,
        title: 'Dam Removal on the Klamath River (True Colour)',
        toTime: '2024-04-11',
      ...
      },
      {
        ...
        description:
          '[Mangrove forests](https://oceanservice.noaa.gov/facts/mangroves.html) have exceptionally high biodiversity and are indispensable in erosion reduction. There are 80 different species of mangrove trees known, growing in low-oxygen soil, where slow moving waters accumulate fine sediments for the roots to grow in. [Sundarbans Mangrove forest](https://whc.unesco.org/en/list/798/) covers 140.000 ha of land, making it one of the largest Mangrove forests in the world. It provides livelihood to many people living in the area and is home to, among others, 250 bird species and an endangered Royal Bengal Tiger. The forest is threatened by seasonal monsoons, cyclones and tidal waves, which cause salinisation. ',
      },
      // {
      //   lat: -15.889,
      //   lng: 46.3548,
      //   zoom: 11,
      //   title: 'Heavy Sedimentation Flow of Betsiboka River (False Colour)',
      //   toTime: '2017-08-12',
      ...
      //   visualizationUrl: `${global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL: FALLBACK_SH_SERVICES_URL}/ogc/wms/25444d-YOUR-INSTANCEID-HERE`,
      //   description:
      //     "A stunning [glacier Grey](https://earthobservatory.nasa.gov/images/7802/grey-glacier-chile) located in Chilean Torres Del Paine National Park is 6 km wide and over 30 metres high at the glacier's front. Its various shades of grey and blue, clearly visible even from space, attract many visitors each year. In 2017 a huge (380 m x 350 m) [iceberg ruptured](https://www.theguardian.com/environment/2017/nov/29/large-iceberg-breaks-off-from-grey-glacier-in-southern-chile) from the glacier with an unknown cause. Such event are very rare - the last one occurred in the early 1990's.. Due to its diverse plants and wildlife, glaciers, rivers, lakes and pampas, the park became [protected as a UNESCO Biosphere reserve](http://www.ecocamp.travel/fr/Patagonia/Torres-del-Paine-National-Park) in 1978. ",
      // },
      {
        lat: 45.4585,
        lng: 12.28701,
      ...
      // },
      {
        title: 'Forest Dieback: Bark Beetles in Frankenwald, Germany',
        lat: 50.31187,
        lng: 11.50818,
        zoom: 13,
        datasetId: 'S2_L2A_CDAS',
        ...
        themeId: 'MONITORING',
        description:
          'This image shows the severe ecological crisis caused by the European spruce bark beetle (Ips typographus) in the Frankenwald forest (Upper Franconia, Bavaria). This mass outbreak, significantly exacerbated by severe heat and drought years spanning roughly 2018 through 2023, led to devastating, large-scale spruce tree mortality. The continuous favourable breeding conditions caused the beetle population to explode, overwhelming the weakened spruce monocultures. Visible from orbit, the damage appears as dramatic, expanding scars: patches of dying, reddish-brown spruce crowns (the initial stage of infestation) and subsequently massive, exposed areas resulting from sanitary clear-cutting operations. These stark, contrasting areas against the healthy green surrounding forest dramatically illustrate the scale of the dieback, turning the former spruce stands into a prominent signature of climate-change-fuelled forest decline across Central Europe.  \nMore information is available [here](https://www.waldwissen.net/en/forestry/forest-protection/detecting-bark-beetle-damage-with-aerial-images#:~:text=The%20highest%20densities%20of%20the,clear%20areas%20%28Figure%201%29)!',
      },
      {
        title: 'West African Heatwave (April 2024)',
        lat: 15.40602,
        lng: -9.66797,
        zoom: 7,
        datasetId: 'COPERNICUS_CLMS_LST_5KM_HOURLY_V2',
        layerId: 'LST',
        visualizationUrl: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/4d1f63-YOUR-INSTANCEID-HERE`,
        fromTime: '2024-04-03T12:00:00.000Z',
        toTime: '2024-04-03T13:59:59.999Z',
        dateMode: 'TIME RANGE',
        mosaickingOrder: 'leastRecent',
        cloudCoverage: 30,
        clmsSelectedPath: 'COPERNICUS_CLMS_LST_5KM_HOURLY_V2',
        clmsSelectedCollection: 'COPERNICUS_CLMS_LST_5KM_HOURLY_V2',
        themeId: 'MONITORING',
        description:
          "This highlight visualises the extreme thermal stress during the deadly West African Heatwave that peaked around April 3, 2024, using Sentinel-3 Land Surface Temperature (LST) data from the Copernicus Land Monitoring Service (CLMS). The satellite image displays LST anomalies corresponding to the soaring air temperatures across the Sahel (where Mali hit a record 48.5℃ on April 3rd), contrasting sharply with seasonal norms. Scientific analysis by World Weather Attribution concluded that human-caused climate change made this kind of intense heat and associated humid heat index—which reached 'danger' or 'extreme danger' levels—about 4℃ hotter and at least 10 times more likely to occur, emphasising the unprecedented and climate-driven nature of this crisis.  \n[Read more](https://www.worldweatherattribution.org/dangerous-humid-heat-in-southern-west-africa-about-4c-hotter-due-to-climate-change/)!",
      },
      {
        title: 'Alpine Scar: Catastrophic Collapse of the Birch Glacier',
        lat: 46.41502,
        lng: 7.84698,
        zoom: 12,
        ...
        themeId: 'MONITORING',
        description:
          'The catastrophic collapse of Birch Glacier in the Swiss Alps on 28 May 2025 was triggered by a rockfall that sent a massive avalanche of ice and debris crashing down to the valley floor. The landslide largely buried the village of Blatten in the Lötschental valley, destroying about 90% of its structures. The resulting debris dammed the Lonza River, creating a significant flood risk. The fresh scar across the valley floor was crucial for rapid damage assessment and emergency response. Satellite imagery immediately enabled disaster teams to map the extent of the debris field and infrastructure loss, including the destroyed village, and to monitor the stability of the river dam to mitigate downstream flood risks.',
      },
      {
        title: 'Restoration Success: Estonian Alvar Grasslands',
        lat: 58.62295,
        lng: 23.10493,
        zoom: 13,
        datasetId: 'S2_L1C_CDAS',
...

  {
    ...
    pins: [
      {
        title: 'Rapeseed Flowering in Mecklenburg-Vorpommern (True Colour)',
        lat: 53.49673,
        lng: 13.58202,
        zoom: 12,
        datasetId: 'S2_L2A_CDAS',
      ...
      {
        title: 'Agriculture in Kansas, USA (False Colour)',
        lat: 37.79317,
        lng: -95.39549,
        zoom: 13,
        datasetId: 'S2_L2A_CDAS',
      ...
      {
        title: 'Agriculture at the Israel-Jordan Border (True Colour)',
        lat: 31.1122,
        lng: 35.4326,
        zoom: 12,
        datasetId: 'S2_L2A_CDAS',
      ...
      // },
      // {
      //   title: 'Agriculture in Limpopo, South Africa (True Colour)',
      //   lat: -24.8591,
      //   lng: 28.78847,
      //   zoom: 13,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      },
      {
        ...
        themeId: 'AGRICULTURE',
        description:
          '[Agriculture in Veneto](https://www.recare-hub.eu/news/45-06-bioforsk) is one of the most productive in Italy, producing mainly cereals, fruit and wine. Small fields cultivated by hand contrast with the increasing industrialisation of the sector, which suffers from soil degradation.',
      },
      // {
...

  {
    ...
    pins: [
      ...
      // },
      {
        ...
        description:
          'The air quality in and around New Delhi has reached alarming levels and is affecting the well-being of residents. The region has been experiencing high concentrations of pollutants from various sources such as vehicular emissions, industrial activities or burning of crops, forming a thick layer of smog, especially during winters. These pollutants can have serious effects on health by causing respiratory problems, aggravating pre-existing conditions and posing risks to cardiovascular health. Sentinel-5P plays a crucial role in monitoring and visualising the extent of air pollution with its spatial resolution of 3.5×5.5 km, daily revisit and advanced atmospheric monitoring capabilities by capturing the distribution of key pollutants in the atmosphere. The satellite data reveals the spatial and temporal patterns of pollution, allowing authorities to identify pollution hotspots and track the movement of pollutants in the region.',
      },
      {
        lat: 13.7900714372,
      ...
      {
        title: 'Mauna Loa Eruption (November–December 2022)',
        lat: 16.44662,
        lng: -156.0498,
        zoom: 7,
        datasetId: 'S5_SO2_CDAS',
        ...
        themeId: 'ATMOSPHERE',
        description:
          "This image shows the reawakening of Mauna Loa, the world's largest active volcano on Hawaiʻi Island, which erupted for the first time in 38 years, beginning on November 27, 2022, and ending on December 13, 2022. The effusive eruption from the Northeast Rift Zone (NERZ) produced dramatic features clearly visible from space: intense thermal signatures and infrared anomalies marked the active lava flows, which travelled approximately 12 miles (19 km) downslope before stalling. Monitoring the concentration and direction of this plume was vital for assessing the impact of vog (volcanic smog) on downwind communities across Hawaiʻi Island. This event was remarkably benign, resulting in no recorded injuries or fatalities. While the main lava flow did temporarily cut off power and access to the Mauna Loa Observatory and threatened the cross-island Saddle Road, it ultimately stalled before causing major infrastructure or property damage.",
      },
      {
      ...
      },
      {
        ...
        themeId: 'ATMOSPHERE',
        description:
          'Hayli Gubbi volcano in Ethiopia erupted on 23 November 2025. It had no previous eruptions in known history. The eruption emitted a massive amount of sulphur dioxide into the upper troposphere that was then carried long distances with the wind. Sentinel-5P measures sulphur dioxide in the total atmospheric column, and has daily coverage of the globe. This map of the sulphur dioxide product shows the distribution of the plume reaching across the eastern Indian Ocean, crossing India and travelling as far as southern China. [Explore the visualisation](https://link.dataspace.copernicus.eu/i5ve).',
      },
    ],
  },

  {
    ...
    pins: [
      ...
      },
      {
        ...
        themeId: 'HISTORICAL',
        description:
          'Perhaps no place on the Earth has had as drastic land cover change over the past ten years as Dubai. The creation of over 300 kilometres of coastline, the rapid expansion of urban land cover, and the intensification of urban development make this one of the most rapidly and visibly changed land covers due to urbanisation. The total population of Dubai has grown by 1.000% over the last 40 years alone. In 1975 the total population was 183.000 inhabitants, which increased in 2015 to about 2 million, making Dubai population one of the fastest growing in the world. The total built up area increased from only 54 square km in 1975 to 977 square km in 2015, raising  urbanised land by 1.800% in only 40 years. Learn more [here](https://lcluc.umd.edu/hotspot/urbanization-dubai#:~:text=Dubai%20has%20experienced%20tremendous%20recent,in%202015%20(AMEInfo%202005a).) and [here](https://www.researchgate.net/publication/317564338_The_Boom_Population_and_Urban_Growth_of_Dubai_City).',
      },
      {
...

  {
    ...
    pins: [
      ...
      },
      {
        ...
        lng: -62.10022,
        zoom: 13,
        title: 'Amazon Drought (Highlight Optimized Natural Colour)',
        toTime: '2023-10-02',
      ...
      },
      {
        ...
        lng: 21.96239,
        zoom: 10,
        title: 'Flooding in Central Greece (False Colour Urban)',
        toTime: '2023-09-10',
      ...
      // },
      {
        title: 'Drought in Denmark (True Colour)',
        lat: 56.2704,
        lng: 10.4713,
        zoom: 10,
        datasetId: 'S2_L2A_CDAS',
...

  {
    ...
    pins: [
      ...
      // },
      // {
      //   title: 'Colca Canyon, Peru (False Colour)',
      //   lat: -15.57451,
      //   lng: -72.09177,
      //   zoom: 13,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      },
      {
        ...
        gain: '1.4',
        description:
          'Instead of its roaring waves and scary storms, the Caribbean sea often offers amazing natural wonders below its otherwise uncertain surface. [The Great Blue Hole of Belize](https://www.marineinsight.com/environment/what-is-the-great-blue-hole-of-belize/), located off the coast of Belize, is one of such wonders. Circular in shape with a diameter of 300 m, the water depth in this hole is 125 m, which gives it a deep blue colour in contrast with the aquamarine colour of the water neighbouring it. Researchers say this giant underwater [sinkhole](https://www.usgs.gov/special-topic/water-science-school/science/sinkholes?qt-science_center_objects=0#qt-science_center_objects) was originally formed during the last glacial period as a limestone cave when the sea levels were lower. As the ocean began to rise due to [thawing](https://www.nationalgeographic.com/environment/global-warming/big-thaw/) of polar ice caps, the cave system flooded and eventually collapsed, creating a “vertical cave” in the ocean. As such, this swallow hole is popular among divers, who flock to the area to see the geological formations that now lie in the ocean’s depths. [Researcher divers](https://geographical.co.uk/people/explorers/item/3132-explore-belize-blue-hole) have found huge [stalactites and stalagmites](https://oceanexplorer.noaa.gov/facts/stalactite.html) below the surface, some even reaching 9 – 12 m in length. They say that the deeper one goes, the clearer the water becomes and the more complex the formations are. The Great Blue Hole is part of the larger Belize Barrier Reef Reserve System, a World Heritage Site of UNESCO.',
      },
      {
      ...
      },
      {
        ...
        themeId: 'GEOLOGY',
        description:
          '[Ha long Bay](https://www.beautifulworld.com/asia/vietnam/ha-long-bay/) is an extraordinary beautiful natural wonder in northern Vietnam’s Quang Ninh Province, near the Chinese border. Covering over 1.500 square km area, it comprises more than 1.600 rocky and earthen islands, typically in the form of jagged limestone pillars jutting out from the sea, and several caves, floating villages and [grottoes](https://en.wikipedia.org/wiki/Grotto), all of which blend together to produce an exotic and picturesque seascape. The existence of surreal seascape has been often explained by the old age [dragon legend](https://www.visithalongbay.com/insight-guides/the-legend-of-halong-bay.html) while scientists have explained that the formations are as a result of 500 million years of strong erosive forces moulding the rocks into fascinating shapes. It is classified as both a [World Heritage Site by UNESCO](https://whc.unesco.org/en/list/672), and as one of the New 7 Wonders of Nature and for many tourists, this place is like something right out of a movie. The fact is that Ha long Bay features a wide range of biodiversity, while the surrealistic scenery has indeed featured in endless movies.',
      },
      // {
...

  {
    ...
    pins: [
      ...
      // },
      // {
      //   title: 'Low Sedimentation Flow of Betsiboka River (False Colour)',
      //   lat: -15.889,
      //   lng: 46.3548,
      //   zoom: 11,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      // },
      {
        ...
        themeId: 'OCEAN',
        description:
          'Natron is a fascinating lake, deadly to most animals, that are not accustomed to its alkaline environment. The dangerously high PH of 10.5 is caused by sodium carbonate flowing in from the surrounding hills, active with volcanism. Sodium carbonate deposits serve as a preservative, calcifying the carcasses of deceased animals. Despite the harsh ecosystem, some species survive here. On its shores, flocks of flamingos, which have evolved leathery skin to tolerate the water, find a safe nesting place, as predators avoid the area. The stunning red colour is caused by cyanobacteria, that thrive in the dry season, as salinity rises due to evaporation. Read more [here](https://www.smithsonianmag.com/travel/flamingos-find-life-among-death-180959265/), [here](https://earthobservatory.nasa.gov/images/90191/lake-natron-tanzania) and [here](https://www.livescience.com/40135-photographer-rick-brandt-lake-natron.html).',
      },
      // {
      //   title: 'Roper River, Tanzania (Enhanced False Colour)',
      //   lat: -14.715,
      //   lng: 135.2479,
      //   zoom: 12,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      // },
      {
        ...
        themeId: 'OCEAN',
        description:
          "The [Tsimlyansk Reservoir](https://www.britannica.com/place/Tsimlyansk-Reservoir) - a big reservoir on the Don River in Russia - is around 250 kilometres long and provides water for a hydropower station, as well as for the irrigation of the surrounding fields. The visualisation aims to dynamically visualise the chlorophyll and sediment concentrations in water bodies, the two primary indicators of water quality. Chlorophyll content ranges in colours from dark blue (low chlorophyll content) through green to red (high chlorophyll content). Sediment concentrations are coloured brown; opaque brown indicates high sediment content. High chlorophyll and sediment concentrations can both be found on the northern shore, coming from the surrounding agricultural fields. This reduces the [reservoir's water quality (pollution, eutrophication, toxification)](https://link.springer.com/article/10.1134/S1875372814020048) which poses a risk for the in situ ecosystem.",
      },
      // {
      ...
      // },
      // {
      //   title: 'Barrier Reef, New Caledonia (Enhanced True Colour)',
      //   lat: -20.2103,
      //   lng: 164.1529,
      //   zoom: 11,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      },
      {
        ...
        themeId: 'OCEAN',
        description:
          'Golden Ray was a roll-on-roll-off car carrier ship, which capsized in Saint Simons Sound off the port of Brunswick, USA due to incorrect loading and ballast management. There was no loss of life, but the ship remained aground for several years. Since it was so large it could not be salvaged, it was cut up into 8 sections on the spot for removal. Unfortunately, during this operation, an oil leak ensued that breached the environmental barrier and was carried further away by currents, causing severe pollution. On this Sentinel-2 true colour image, you can see the oil as bright, shiny streaks on the water surface. If you create a timelapse from September 2019 to October 2021, you can follow the full process of salvage. The yellow arches are VB-10.000, a special salvage ship that was used during the operation. [Explore the visualisation](https://link.dataspace.copernicus.eu/e6c9).',
      },
    ],
  },

  {
    ...
    pins: [
      ...
      },
      {
        ...
        themeId: 'SNOW',
        description:
          'Satellite imagery is essential not only for monitoring snow and ice processes, but also for tracking the activity of endangered species that live in such environments. One of the most prominent examples is the discovery and observation of Emperor Penguin colonies in Antarctica: this species breeds on the ice surface (as opposed to bare rock or ground), and its guano produces stains that can be clearly identified. This Sentinel-2 image is visualised with the Penguin Locator custom script, enhancing small differences between the red, green and blue bands of the dataset to highlight different types and thicknesses of ice, and of course, penguin colonies. This kind of observation supports Copernicus-based environmental monitoring and complements ESA-led Earth observation efforts in polar regions.',
      },
      {
        title: 'Bear Glacier, Alaska (Highlight Optimized Natural Colour)',
        lat: 60.0004,
        lng: -149.7066,
        zoom: 12,
        datasetId: 'S2_L2A_CDAS',
      ...
      //   themeId: 'SNOW',
      //   description:
      //     "The stunning [glacier Grey](https://earthobservatory.nasa.gov/images/7802/grey-glacier-chile) located in the Chilean Torres Del Paine National Park is 6 km wide and over 30 metres high at the glacier's front. Its various shades of grey and blue, clearly visible even from space, attract many visitors each year. In 2017 a huge (380 m x 350 m) [iceberg ruptured](https://www.theguardian.com/environment/2017/nov/29/large-iceberg-breaks-off-from-grey-glacier-in-southern-chile) from the glacier with the cause unknown. Such events are very rare, with the last one occurring in the early 1990's. Due to its diverse plants and wildlife, glaciers, rivers, lakes and pampas, the park became [protected as a UNESCO Biosphere reserve](http://www.ecocamp.travel/fr/Patagonia/Torres-del-Paine-National-Park) in 1978.",
      // },
      // {
      ...
      // },
      {
        ...
        gain: '1.1',
        description:
          '[Sermeq Kujalleq](https://www.atlasobscura.com/articles/worlds-fastest-glacier-sermeq-kujalleq), also called Jakobshavn glacier, is known as the world’s fastest glacier. It travels an average of 130 feet in 24 hours and calves more than 45 cubic kilometres of icebergs each year into the Ilulissat Icefjord. Its front is an enormous ice wall, stretching 91 meters at its peak, which constantly explodes. Icebergs break off the glacier accompanied by blasts and roars akin to a rocket launch. When they hit the sea below, the calved icebergs can create huge waves that threaten to swallow people, boats, and buildings. The icebergs from Sermeq Kujalleq have crashed so violently that they have even caused earthquakes. Because the glacier is so large, the breaks seem to occur in __slow motion__.',
      },
      // {
      //   title: 'Glaciers of western Greeenland (Tonemapped Natural Colour) ',
      //   lat: 72.9559,
      //   lng: -54.5735,
      //   zoom: 10,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      // },
      {
        title: 'Helheim Glacier, Greenland (Highlight Optimized Natural Colour)',
        lat: 66.3767,
        lng: -38.1474,
        zoom: 11,
        datasetId: 'S2_L2A_CDAS',
      ...
      {
        title: 'Byrd Glacier, Antarctica (Highlight Optimized Natural Colour)',
        lat: -80.56,
        lng: 156.672,
        zoom: 8,
        datasetId: 'S2_L2A_CDAS',
      ...
      //   gain: '1.4',
      //   description:
      //     'The mountains around Lake Te Anau (west) and Lake Wakatipu (east) on New Zealand’s South Island are located in the Fiorland National Park. Lake Te Anau is home to the only inland fjords in New Zealand originating from the time when the mountain’s glaciers were still reaching far down the valleys. Today covered with snow in winter these more than 2000 m high peaks are a popular destination for trekking and mountaineering [more](http://www.teanau.net.nz/Mountains). They are also home to an almost extinct bird species called [takahe](http://www.teanau.net.nz/See-a-takahe).',
      // },
      // {
      //   title: 'Mountain Rivers, New Zealand (False Colour)',
      //   lat: -43.7677,
      //   lng: 170.319,
      //   zoom: 11,
      //   datasetId: 'S2_L2A_CDAS',
      ...
      //   themeId: 'SNOW',
      //   description:
      //     'The southern Alps in New Zealand are widely covered with snow in winter. The strong red colours mainly in the southeast corner indicated healthy vegetation. The different colours of the lakes’ origin from different mixtures of minerals brought by the streams from the surrounding mountains.',
      // },
      {
      ...
      },
      {
        ...
        themeId: 'SNOW',
        description:
          'A winter landscape of the [Christina Lake Oil Sands Factory](https://www.cenovus.com/operations/oilsands/christina-lake.html). The factory uses specialised technology to drill and pump the oil from 375 metres deep underground. The project is expected to last for more than 30 years and produces 210.000 barrels of oil per day. In winter, the lakes are covered by snow, giving them a surreal white colour.',
      },
      // {
...

  {
    ...
    content: [
      {
        name: 'Urban (S2 Quarterly Mosaics)',
        service: 'WMS',
        url: `${
          global.window ? global.window.API_ENDPOINT_CONFIG.SH_SERVICES_URL : FALLBACK_SH_SERVICES_URL
        }/ogc/wms/867895-YOUR-INSTANCEID-HERE`,
    ...
    pins: [
      ...
      },
      {
        ...
        themeId: 'URBAN',
        description:
          "[Amsterdam's](https://www.britannica.com/place/Amsterdam) name derives from [Amstelredamme](https://en.wikipedia.org/wiki/Amsterdam#:~:text=Found%20within%20the%20province%20of,dam%20in%20the%20river%20Amstel.) and indicative of the city's origin around a dam in the river Amstel. Originating as a small fishing village in the late 12th century, Amsterdam became one of the most important ports in the world during the Dutch Golden Age in the 17th century, and became the leading centre for finance and trade. Even today the Port of Amsterdam is the fourth largest port in Europe and still growing. Large ports are usually ecologically disastrous. Amsterdam however, aims to change this by making every effort to keep physical and environmental impact to a minimum and be at the top of Europe's [sustainable ports](https://www.portofamsterdam.com/en/discover/sustainable-port) by 2030. A special focus is currently put on plastics recycling. For example, the Plastic Whale organisation builds small boats almost entirely out of old plastics, then uses them to gather plastic out of the Amsterdam waterway. Additionally, Amsterdam is [famous for](https://viatravelers.com/amsterdam-is-famous-for/) its diversity, the Van Gogh art museum, the Anne Frank House and tulips.",
      },
      // {
      //   title: 'Taizhou, China',
      //   lat: 32.4481,
      ...
      },
      {
        ...
        themeId: 'URBAN',
        description:
          '[Toronto](https://www.britannica.com/place/Toronto), the most populous city in Canada, is a multicultural city, and the country’s financial and commercial centre. It has a well developed education system, with [50 % of the workforce having a university degree](https://www.narcity.com/ca/on/toronto/lifestyle/50-fun-facts-every-true-torontonian-will-definitely-love). One of the most distinctive features of the geography of Toronto is the Toronto [ravine system](https://en.wikipedia.org/wiki/Toronto_ravine_system#cite_note-1). It is a network of deep ravines that form a large urban forest that runs throughout much of the city. For the most part designated as parkland, the ravines are largely undeveloped. Toronto\'s slogan "_The city within a park_" partially stems from the extensive ravine green space with some 10 million trees and 1.500 parks, covering 18 % of the city area. The terrain that the city of Toronto sits on was formed by glaciers after the end of the last ice age about 12.000 years ago. Over the millennia, small rivers and creeks eroded the soil, cutting deep ravines through what is today the Toronto region. Despite the dense population of metropolitan Toronto, many of the ravines have been left close to their natural state, due to the danger of flooding. Every few decades, a massive flooding event occurs. The most recent event was in 1954, when Hurricane Hazel dropped over 12 cm of rain onto the city in a single day. In the post-war years, several developments had begun to encroach on the ravine lands, and these neighbourhoods were badly damaged by the storm. Whole blocks were washed away and 81 people were killed. This disaster led to an almost complete ban on development in the ravines, and a new Region Conservation Authority was created to maintain them as open spaces.',
      },
      {
      ...
      },
      {
        ...
        themeId: 'URBAN',
        description:
          '[Tabriz](https://www.britannica.com/place/Tabriz), the fourth largest city of Iran and capital of the East Azerbaijan province, counts almost 1,4 million inhabitants. The name Tabriz is said to derive from tap-rīz (“causing heat to flow”), from the many thermal springs in the area. Iran is prone to earthquakes as it sits on [major fault lines](https://www.rferl.org/a/earthquake-hits-northwest-iran-tabriz/30259208.html) and experiences an average of one earthquake a day. Consequently, Tabriz, which lies about 1,367 metres above sea level, is prone to frequent and deadly earthquakes, which cause serious damages and casualties. The city has been occupied several times throughout history. The modernisation of Tabriz has quickened since World War II, with streets widened, buildings erected, and public gardens laid out with fountains and pools. The city’s newer buildings include a railway station and Tabriz University. The city is commercially important, with the principal products including carpets, textiles, cement, agricultural machinery, motorcycles, and household appliances. The city is linked by rail with Tehran and with areas to the north, and it has an airport.',
      },
      {
        title: 'Venice, Italy',
        lat: 45.4585,
        ...
        themeId: 'URBAN',
        description:
          "[Venice](https://www.britannica.com/place/Venice/Lagoon-and-tides), a so-called island city with a population of [637,245](https://worldpopulationreview.com/world-cities/venice-population/), remains a major Italian port and is one of the world’s oldest tourist and cultural centres. The lagoon's mud banks, shallows, and channels with their marine and bird life provide next to salt pans a source of income for the Venetians. The lagoon has served as protection and as a natural sewerage system. The deepening of channels in the 20th century, the overextraction of fresh water from mainland aquifers, the rising of the Adriatic Sea, and the geologic sinking of the Po River basin have lowered the land level, creating a serious flooding problem. On a regular basis, when high tides combine with winds from the south and east, the waters of the lagoon rise and flood the city, making Venice known as the [City built on water](https://www.livitaly.com/how-was-venice-built/).",
      },
      // {
      ...
      },
      {
        ...
        themeId: 'URBAN',
        description:
          'Ptuj is the oldest town in Slovenia, dating back to the Stone Age. Due to its strategic location along a prehistoric trade route between the Baltic Sea and the Adriatic, it became an important centre and legion-camp of the Ancient Romans. This is also how it got its name - the romans named it Poetovium. The town is dominated by the [castle](https://www.culture.si/en/Ptuj_Castle), standing proudly on the hill above Ptuj. Its strategic position at the bank of Drava river allowed the castle hill to be inhabited since the early days of Ptuj and Ptuj kept an important role over centuries. The current look of the building dates back to the 18th century and is home to a museum that hosts the biggest collection of music instruments in the whole country. Ptuj is the centre place of a carnival in spring, an ancient rite of spring and fertility, called Kurentovanje. [Kurent](http://www.kurentovanje.net/en/the-kurent/) is a figure dressed in sheep skin wearing a mask, a long red tongue, cow bells, and multi-coloured ribbons on the head. Organised in groups, Kurents go through towns, from house to house, making noise with bells to symbolically scare off evil spirits and the winter. Kurent has been recognised by [UNESCO](https://www.slovenia.info/en/places-to-go/regions/thermal-pannonian-slovenia/ptuj) for its unique cultural heritage. Each year, more than [100.000](https://govorise.metropolitan.si/dogodki/pustovanja-2019-po-sloveniji-od-povorke-v-ptuju-do-priljubljenega-cerknega/) people gather for the largest carnival in the country. Learn more [here](https://www.mywanderlust.pl/visit-ptuj-slovenia/) and [here](https://en.wikipedia.org/wiki/Ptuj).',
      },
      // {
      ...
      {
        title: "Green Oasis: Riga's Extensive Urban Green Spaces",
        lat: 56.94455,
        lng: 24.13731,
        zoom: 13,
        datasetId: '5460de-YOUR-INSTANCEID-HERE',
    ...
    pins: [
      {
        ...
        themeId: 'FORESTRY',
        description:
          '[Mangrove forests](https://oceanservice.noaa.gov/facts/mangroves.html) have exceptionally high biodiversity and are essential for erosion control. There are 80 known species of mangrove trees that grow in oxygen poor soils, where slow-moving water accumulates fine sediments in which roots can grow and salinisation can occur. [The Sundarbans Mangrove Forest](https://www.esa.int/ESA_Multimedia/Images/2016/07/Sundarbans_web) covers 140.000 hectares of land, making it one of the largest mangrove forests in the world. It provides a livelihood for many people in the region and is home to 250 bird species and the endangered Royal Bengal Tiger, among others. The forest protects the coast from seasonal monsoons, cyclones and tidal waves. Learn more [here](https://whc.unesco.org/en/list/798/).',
      },
      {
        title: 'Serengeti National Park (Barren Soil)',
        lat: -1.5937,
        lng: 34.8469,
        zoom: 12,
        datasetId: 'S2_L2A_CDAS',
      ...
      // {
      //   title: 'Forestry in the Amazon Rainforest (True Colour)',
      //   lat: -9.3756,
      //   lng: -52.1178,
      //   zoom: 11,
      //   datasetId: 'S2_L2A_CDAS',
    ...
    pins: [
      {
        ...
        lng: -98.64796,
        zoom: 13,
        title: 'Popocatépetl Ash Emission (True Colour)',
        toTime: '2024-03-06',
        layerId: 'TRUE-COLOR',
        themeId: 'VOLCANOES',
        datasetId: 'S2_L2A_CDAS',
      ...
      //   themeId: 'VOLCANOES',
      //   description:
      //     '[Mount Etna](https://whc.unesco.org/en/list/1427/) on the Italian island of Sicily is the highest active volcano in Europe. It currently reaches a height of 3320 metres (changes due to deposits from eruptions and collapses of the crater) and covers an impressive area of 1.600 square kilometres. On its lower slopes are hot vineyards, olive groves and orchards. There are several smaller and larger settlements around the foot of the volcano. Etna is currently very active and has experienced four strombolian [eruptions](https://www.esa.int/ESA_Multimedia/Images/2021/02/Etna_erupts) in the last five years.',
      // },
      // {
      //   title: 'Nyiragongo (False Colour Urban)',
      //   lat: -1.5220378,
      ...
      // },
      {
        title: 'Kilauea (False Colour Urban)',
        lat: 19.3523,
        lng: -155.2516,
        zoom: 12,
        datasetId: 'S2_L1C_CDAS',
