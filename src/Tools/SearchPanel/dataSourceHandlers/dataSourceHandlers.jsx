...
import {
  ...
  COPERNICUS_CLMS_CPFLP_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_COLLECTION_IDS,
  ...
  COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_VLCC_GRASSLAND_CHANGE_EUROPE_20M_3YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_VLCC_TCPC_20M_3YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1_COLLECTION_IDS,
  ...
  COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1_COLLECTION_IDS,
...
export function datasourceForDatasetId(datasetId) {
  ...
  switch (datasetId) {
    ...
    case COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT0:
    case COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT1:
    case COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT2:
    case COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT6:
    ...
    case COPERNICUS_CLMS_UA_BUILDING_HEIGHT_EUROPE_10M_3YEARLY_V1_2021_COLLECTION_ID.ACTUAL:
    case COPERNICUS_CLMS_CPFLP_10M_YEARLY_V1:
    case COPERNICUS_CLMS_CPFLP_10M_YEARLY_V1_COLLECTION_IDS.FLP:
    case COPERNICUS_CLMS_CPFLP_10M_YEARLY_V1_COLLECTION_IDS.FLPCL:
    case COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1:
    case COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_COLLECTION_IDS.CPBSA:
    case COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_COLLECTION_IDS.CPBSACL:
    case COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1:
    case COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_COLLECTION_IDS.CPFLD:
    case COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_COLLECTION_IDS.CPFLDCL:
    case COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1:
    case COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_COLLECTION_IDS.CPBSB:
    case COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_COLLECTION_IDS.CPBSBCL:
    case COPERNICUS_CLMS_DLTC_EUROPE_20M_3YEARLY_V1:
    case COPERNICUS_CLMS_DLTC_EUROPE_20M_3YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_DLT_10M_YEARLY_V1:
    case COPERNICUS_CLMS_DLT_10M_YEARLY_V1_COLLECTION_IDS.DLT:
    case COPERNICUS_CLMS_DLT_10M_YEARLY_V1_COLLECTION_IDS.DLTCL:
    case COPERNICUS_CLMS_VLCC_CROP_TYPES_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_CROP_TYPES_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CTY:
    case COPERNICUS_CLMS_VLCC_CROP_TYPES_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CTYCL:
    case COPERNICUS_CLMS_CPMCD_10M_YEARLY_V1:
    case COPERNICUS_CLMS_CPMCD_10M_YEARLY_V1_COLLECTION_IDS.CPMCD:
    case COPERNICUS_CLMS_CPMCD_10M_YEARLY_V1_COLLECTION_IDS.CPMCDCL:
    case COPERNICUS_CLMS_VLCC_TCPC_20M_3YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_TCPC_20M_3YEARLY_V1_COLLECTION_IDS.TCPC:
    case COPERNICUS_CLMS_VLCC_TCPC_20M_3YEARLY_V1_COLLECTION_IDS.TCPCCL:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_CHANGE_EUROPE_20M_3YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_CHANGE_EUROPE_20M_3YEARLY_V1_COLLECTION_IDS.GRAC:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_CHANGE_EUROPE_20M_3YEARLY_V1_COLLECTION_IDS.GRACCL:
    case COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_10M_3YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_10M_3YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.GRA:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.GRACL:
    ...
    case COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_SECONDARY_CROP_TYPES_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_DATES_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_CROPPING_SEASONS_TYPES_EUROPE_10M_YEARLY_V1:
    ...
    case COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.TCD:
    case COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.TCDCL:
    case COPERNICUS_CLMS_LST_GLOBAL_3KM_HOURLY_V3:
    case COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CPSCD:
    case COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CPSCDCL:
    ...
    case COPERNICUS_CLMS_VLCC_PLOUGHING_INDICATOR_EUROPE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.GRAME:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.GRAMECL:
    case COPERNICUS_CLMS_VLCC_SECONDARY_CROP_TYPES_EUROPE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_DATES_EUROPE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_CROPPING_SEASONS_TYPES_EUROPE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_HERBACEOUS_COVER_EUROPE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_CROPPING_SEASONS_EUROPE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_CPSCE_10M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_BROADLEAVED_COVER_DENSITY_EUROPE_100M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_CONIFEROUS_COVER_DENSITY_EUROPE_100M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_100M_3YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_100M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_100M_YEARLY_V1_COLLECTION_ID:
    case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CPMCH:
    case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL:
    case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1:
    case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE:
    case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL:
    case COPERNICUS_CLMS_CLCPLUS_LULUCF_INSTANCE_EUROPE_100M_YEARLY_V1:
    case COPERNICUS_CLMS_CLCPLUS_LULUCF_INSTANCE_EUROPE_100M_YEARLY_V1_COLLECTION_IDS.ACTUAL:
    ...
    case CDSE_CCM_VHR_IMAGE_MOSAIC_2024_COLLECTION:
...
export const datasetLabels = {
  ...
  [S3SLSTRL2_CDAS]: 'Sentinel-3 SLSTR L2',
  ...
  [CDSE_CCM_VHR_IMAGE_MOSAIC_2024_COLLECTION]: 'VHR Europe 2024 Mosaic',
  ...
  [COPERNICUS_CLMS_VLCC_CROP_TYPES_EUROPE_10M_YEARLY_V1]: t`CTY 10m Yearly (2017–present)`,
  ...
  [COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1]: t`GRAME 10m Yearly (2017–present)`,
  [COPERNICUS_CLMS_VLCC_SECONDARY_CROP_TYPES_EUROPE_10M_YEARLY_V1]: t`CPSCT 10m Yearly (2017–present)`,
  [COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_DATES_EUROPE_10M_YEARLY_V1]: t`GRAMD 10m Yearly (2017–present)`,
  [COPERNICUS_CLMS_VLCC_CROPPING_SEASONS_TYPES_EUROPE_10M_YEARLY_V1]: t`CPCST 10m Yearly (2017–present)`,
  [COPERNICUS_CLMS_VLCC_HERBACEOUS_COVER_EUROPE_10M_YEARLY_V1]: t`HER 10m Yearly (2017–present)`,
  [COPERNICUS_CLMS_VLCC_CROPPING_SEASONS_EUROPE_10M_YEARLY_V1]: t`CPCSY 10m Yearly (2017–present)`,
  ...
  [COPERNICUS_CLMS_FCOVER_GLOBAL_300M_10DAILY_V2_RT0]: t`FCOVER 300m 10-daily V2 RT0`,
  [COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT0]: t`LAI 300m 10-daily V2 RT0`,
  [COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT1]: t`LAI 300m 10-daily V2 RT1`,
  [COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT2]: t`LAI 300m 10-daily V2 RT2`,
  [COPERNICUS_CLMS_LAI_GLOBAL_300M_10DAILY_V2_RT6]: t`LAI 300m 10-daily V2 RT6`,
  [COPERNICUS_CLMS_FAPAR_300M_10DAILY_V2_RT0]: t`FAPAR 300m 10-daily V2`,
  ...
  [COPERNICUS_CLMS_WSI_WATER_COVER_DURATION_EUROPE_UTM_10M_YEARLY_V1]: t`WCD Europe 10m Yearly V1`,
  [COPERNICUS_CLMS_WSI_ICE_COVER_DURATION_EUROPE_UTM_20M_YEARLY_V1]: t`ICD Europe 20m Yearly V1`,
  [COPERNICUS_CLMS_WSI_WATER_ICE_COVER_S1_EUROPE_UTM_60M_DAILY_V1]: t`WIC S1 Europe 60m Daily V1`,
  [COPERNICUS_CLMS_WSI_WATER_ICE_COVER_S2_EUROPE_UTM_20M_DAILY_V1]: t`WIC S2 Europe 20m Daily V1`,
  [COPERNICUS_CLMS_WSI_WATER_ICE_COVER_S1_S2_EUROPE_UTM_20M_DAILY_V1]: t`WIC S1+S2 Europe 20m Daily V1`,
  ...
  [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1]: t`CPMCH 10m Yearly (2017–present)`,
  [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1]: t`CPMCE 10m Yearly (2017–present)`,
