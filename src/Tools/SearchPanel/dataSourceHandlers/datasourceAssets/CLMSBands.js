...
export const COPERNICUS_CLMS_WSI_ICE_COVER_DURATION_EUROPE_UTM_20M_YEARLY_V1_BANDS = [
  {
    name: 'ICD',
    sampleType: 'UINT16',
    getDescription: () => ``,
...
export const COPERNICUS_CLMS_WSI_WATER_COVER_DURATION_EUROPE_UTM_10M_YEARLY_V1_BANDS = [
  {
    name: 'WCD',
    sampleType: 'UINT16',
    getDescription: () => ``,
