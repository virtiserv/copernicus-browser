...
export const collections = [
  {
    ...
    instruments: [
      ...
      },
      {
        ...
        supportsInstrumentName: false,
        productTypes: [
          { id: 'AUX_CAL', name: 'AUX_CAL', label: 'AUX_CAL', supportsGeometry: false },
          { id: 'AUX_INS', name: 'AUX_INS', label: 'AUX_INS', supportsGeometry: false },
          { id: 'AUX_ML2', name: 'AUX_ML2', label: 'AUX_ML2', supportsGeometry: false },
          { id: 'AUX_PP1', name: 'AUX_PP1', label: 'AUX_PP1', supportsGeometry: false },
          { id: 'AUX_PP2', name: 'AUX_PP2', label: 'AUX_PP2', supportsGeometry: false },
          { id: 'AUX_SCS', name: 'AUX_SCS', label: 'AUX_SCS', supportsGeometry: false },
          {
            id: 'AMH_ERRMAT',
            name: 'AMH_ERRMAT',
            label: 'AMH_ERRMAT',
...
// A single group node wrapping all complementary-data collections (Landsat-8/9, Landsat
// Mosaic, MODIS, ...) under one "Complementary Data" entry in the sidebar. Not a flat list
// like `collections` above - pushed as one node into recursiveCollections below, so any
// collection nested here is one level deeper than a top-level entry in `collections`.
export const complementaryDataGroup = {
  ...
  items: [
    ...
    {
      id: ODataCollections.LANDSAT_MOSAIC_BI_MONTHLY.id,
      label: ODataCollections.LANDSAT_MOSAIC_BI_MONTHLY.label,
      collectionName: ODataCollections.LANDSAT_MOSAIC_BI_MONTHLY.collection,
      type: 'collection',
      hideChildren: true,
      items: [
        {
          id: 'landsat_mosaic',
          label: 'landsat_mosaic',
          type: 'productType',
          items: [],
        },
      ],
    ...
    {
      id: ODataCollections.MODIS_TERRA.id,
      label: ODataCollections.MODIS_TERRA.label,
      collectionName: ODataCollections.MODIS_TERRA.collection,
      type: 'collection',
      supportsCloudCover: false,
      items: [
        {
          ...
          items: [
            {
              id: 'MOD17A2H.061',
              name: 'MOD17A2H.061',
              label: 'Gross Primary Productivity 8-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD17A2HGF.061',
              name: 'MOD17A2HGF.061',
              label: 'Gross Primary Productivity Gap-Filled 8-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD11A1.061',
              name: 'MOD11A1.061',
              label: 'Land Surface Temperature/Emissivity Daily Global 1km',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD11A2.061',
              name: 'MOD11A2.061',
              label: 'Land Surface Temperature/Emissivity 8-Day Global 1km',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD21A2.061',
              name: 'MOD21A2.061',
              label: 'Land Surface Temperature/3-Band Emissivity 8-Day Global 1km',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD15A2H.061',
              name: 'MOD15A2H.061',
              label: 'Leaf Area Index/FPAR 8-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD16A2GF.061',
              name: 'MOD16A2GF.061',
              label: 'Net Evapotranspiration Gap-Filled 8-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD16A3GF.061',
              name: 'MOD16A3GF.061',
              label: 'Net Evapotranspiration Gap-Filled Yearly Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD17A3HGF.061',
              name: 'MOD17A3HGF.061',
              label: 'Net Primary Production Gap-Filled Yearly Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD10A1.061',
              name: 'MOD10A1.061',
              label: 'Snow Cover Daily Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD10A2.061',
              name: 'MOD10A2.061',
              label: 'Snow Cover 8-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD09Q1.061',
              name: 'MOD09Q1.061',
              label: 'Surface Reflectance 8-Day Global 250m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD09A1.061',
              name: 'MOD09A1.061',
              label: 'Surface Reflectance 8-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD14A1.061',
              name: 'MOD14A1.061',
              label: 'Thermal Anomalies/Fire Daily Global 1km',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD14A2.061',
              name: 'MOD14A2.061',
              label: 'Thermal Anomalies/Fire 8-Day Global 1km',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD13Q1.061',
              name: 'MOD13Q1.061',
              label: 'Vegetation Indices 16-Day Global 250m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD13A1.061',
              name: 'MOD13A1.061',
              label: 'Vegetation Indices 16-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MOD13A2.061',
              name: 'MOD13A2.061',
              label: 'Vegetation Indices 16-Day Global 1km',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
          ],
    ...
    {
      id: ODataCollections.MODIS_AQUA.id,
      label: ODataCollections.MODIS_AQUA.label,
      collectionName: ODataCollections.MODIS_AQUA.collection,
      type: 'collection',
      supportsCloudCover: false,
      items: [
        {
    ...
    {
      id: ODataCollections.MODIS_TERRAAQUA.id,
      label: ODataCollections.MODIS_TERRAAQUA.label,
      collectionName: ODataCollections.MODIS_TERRAAQUA.collection,
      type: 'collection',
      supportsCloudCover: false,
      items: [
        {
          ...
          items: [
            {
              id: 'MCD43A4.061',
              name: 'MCD43A4.061',
              label: 'BRDF/Albedo Nadir BRDF-Adjusted Daily Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MCD64A1.061',
              name: 'MCD64A1.061',
              label: 'Direct Broadcast Burned Area Monthly Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MCD12Q1.061',
              name: 'MCD12Q1.061',
              label: 'Land Cover Type Yearly Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
              id: 'MCD15A3H.061',
              name: 'MCD15A3H.061',
              label: 'Leaf Area Index/FPAR 4-Day Global 500m',
              customFilterQueryByProductType: true,
              type: 'productType',
            },
            {
            ...
            items: [
              {
                ...
                items: [
                  ...
                  {
                    id: COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_100M_YEARLY_V1_DATASET_IDENTIFIER,
                    label: 'GRA, Europe, 100m, yearly, (2017–present), V1',
                    type: 'productType',
                    customFilterExpression: `(${FilterElement.Attribute(
                      ODataAttributes.datasetIdentifier,
                      ODataFilterOperator.eq,
        ...
        items: [
          {
            ...
            items: [
              {
                id: 'BROADLEAVED_COVER_DENSITY',
                label: 'Broadleaved Cover Density',
                type: 'group',
                items: [
                  {
                    id: COPERNICUS_CLMS_VLCC_BROADLEAVED_COVER_DENSITY_EUROPE_100M_YEARLY_V1_DATASET_IDENTIFIER,
                    label: 'BCD, Europe, 100m, Yearly, (2018–present), V1',
                    type: 'productType',
                    customFilterExpression: `(${FilterElement.Attribute(
                      ODataAttributes.datasetIdentifier,
                      ODataFilterOperator.eq,
            ...
            items: [
              {
                ...
                items: [
                  ...
                  {
                    id: COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_100M_3YEARLY_V1_DATASET_IDENTIFIER,
                    label: 'FTY, Europe, 100m, 3-yearly, (2018–2021), V1',
                    type: 'productType',
                    customFilterExpression: `(${FilterElement.Attribute(
                      ODataAttributes.datasetIdentifier,
                      ODataFilterOperator.eq,
            ...
            items: [
              {
                ...
                items: [
                  ...
                  {
                    id: COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_100M_YEARLY_V1_DATASET_IDENTIFIER,
                    label: 'TCD, Europe, 100m, yearly, (2018–present), V1',
                    type: 'productType',
                    customFilterExpression: `(${FilterElement.Attribute(
                      ODataAttributes.datasetIdentifier,
                      ODataFilterOperator.eq,
...
recursiveCollections.push(complementaryDataGroup);
