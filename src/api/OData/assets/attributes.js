...
export const FormatedAttributeNames = {
  ...
  sensorType: () => t`Sensor type`,
  orderReference: () => t`Order reference`,
  sunAzimuthAngle: () => t`Sun azimuth angle`,
  sunElevationAngle: () => t`Sun elevation angle`,
  alongTrackIncidenceAngle: () => t`Along track incidence angle`,
  cloudCoverLand: () => t`Cloud cover land`,
  collectionCategory: () => t`Collection category`,
  collectionNumber: () => t`Collection number`,
  geometricRmse: () => t`Geometric RMSE`,
  geometricXBias: () => t`Geometric X bias`,
  geometricYBias: () => t`Geometric Y bias`,
  geometricXStddev: () => t`Geometric X standard deviation`,
  geometricYStddev: () => t`Geometric Y standard deviation`,
  offNadir: () => t`Off nadir`,
...
export const ODataAttributes = {
  ...
  datasetAlias: new ODataStringAttribute(AttributeNames.datasetAlias),
