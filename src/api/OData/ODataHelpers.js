...
const PRODUCT_TYPE_TO_DATASETID = {
  ...
  L1TP: CDAS_L8_L9_LOTL1,
  L1GT: CDAS_L8_L9_LOTL1,
  ...
  'lst-tci_global_3km_10daily_v3': COPERNICUS_CLMS_LST_TCI_GLOBAL_3KM_10DAILY_V3,
  ...
  lst_global_3km_hourly_v3: COPERNICUS_CLMS_LST_GLOBAL_3KM_HOURLY_V3,
  ...
  'lst-daily-cycle_global_3km_10daily_v3': COPERNICUS_CLMS_LST_DAILY_CYCLE_GLOBAL_3KM_10DAILY_V3,
  ...
  [COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_DATASET_IDENTIFIERS.CPBSA]: COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1,
  [COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_DATASET_IDENTIFIERS.CPBSACL]: COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1,
  [COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_DATASET_IDENTIFIERS.CPFLD]: COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1,
  [COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_DATASET_IDENTIFIERS.CPFLDCL]: COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1,
  [COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_DATASET_IDENTIFIERS.CPBSB]: COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1,
  [COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_DATASET_IDENTIFIERS.CPBSBCL]: COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1,
  ...
  'clms_vlcc_herbaceous-cover_europe_10m_yearly_v1':
    COPERNICUS_CLMS_VLCC_HERBACEOUS_COVER_EUROPE_10M_YEARLY_V1,
  'clms_vlcc_secondary-crop-emergence_europe_10m_yearly_v1': COPERNICUS_CLMS_CPSCE_10M_YEARLY_V1,
  ...
  'clms_wsi_fractional-snow-cover_europe_utm_20m_daily_v2':
    COPERNICUS_CLMS_WSI_FRACTIONAL_SNOW_COVER_EUROPE_UTM_20M_DAILY_V2,
  'clms_wsi_sar-wet-snow_europe_utm_60m_daily_v2': COPERNICUS_CLMS_WSI_SAR_WET_SNOW_EUROPE_UTM_60M_DAILY_V2,
  'clms_wsi_wet-dry-snow_europe_utm_60m_daily_v2': COPERNICUS_CLMS_WSI_WET_DRY_SNOW_EUROPE_UTM_60M_DAILY_V2,
...
const VLCC_MULTI_LAYER_ODATA_CONFIG = {
  ...
  [COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1]: {
    instrument: 'CROPPING_PATTERNS',
    layerIds: COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
  [COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1]: {
    instrument: 'CROPPING_PATTERNS',
    layerIds: COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
  [COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1]: {
    instrument: 'CROPPING_PATTERNS',
    layerIds: COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
  [COPERNICUS_CLMS_DLT_10M_YEARLY_V1]: {
  ...
  [COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1]: {
    instrument: 'GRASSLAND_MOWING_EVENTS',
    layerIds: COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_EVENTS_EUROPE_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
  [COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1]: {
    instrument: 'CROPPING_PATTERNS',
    layerIds: COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
  [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1]: {
    instrument: 'CROPPING_PATTERNS',
    layerIds: COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_EUROPE_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
  [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1]: {
    instrument: 'CROPPING_PATTERNS',
    layerIds: COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1_LAYER_IDS,
    datasetIdentifiers: COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_EUROPE_10M_YEARLY_V1_DATASET_IDENTIFIERS,
  },
};
...
export const getODataCollectionInfoFromDatasetId = (datasetId, { orbitDirection, maxCC, layerId }) => {
    ...
    return [
      {
        ...
        selectedFilters: {
          ...
          polarisationChannels: [
            ...(datasetParams.polarization === Polarization.SV
            ...
            ...(datasetParams.polarization === Polarization.DV
              ...
              : []),
            ...(datasetParams.polarization === Polarization.SH
  ...
  if ([COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_100M_YEARLY_V1].includes(datasetId)) {
    return [
      {
        id: ODataCollections.CLMS_LAND_COVER_AND_LAND_USE_MAPPING.id,
        instrument: 'TREE_COVER_DENSITY',
  ...
  if ([COPERNICUS_CLMS_VLCC_GRASSLAND_MOWING_DATES_EUROPE_10M_YEARLY_V1].includes(datasetId)) {
    return [
      {
        id: ODataCollections.CLMS_LAND_COVER_AND_LAND_USE_MAPPING.id,
        instrument: 'GRASSLAND_MOWING_EVENTS',
  ...
  if ([COPERNICUS_CLMS_VLCC_HERBACEOUS_COVER_EUROPE_10M_YEARLY_V1].includes(datasetId)) {
    return [
      {
        id: ODataCollections.CLMS_LAND_COVER_AND_LAND_USE_MAPPING.id,
        instrument: 'GRASSLAND_AND_HERBACEOUS',
  ...
  if ([COPERNICUS_CLMS_WSI_CLOUD_CLASSIFICATION_EUROPE_UTM_20M_DAILY_V1].includes(datasetId)) {
    return [
      {
        id: ODataCollections.CLMS_BIOGEOPHYSICAL_PARAMETERS.id,
        instrument: 'AUXILIARY_DATA',
        productType: getProductTypeFromDatasetId(datasetId),
        selectedFilters: {},
      },
    ];
  ...
  // CLMS WSI Water and Ice Cover datasets map to one item on the Search tab that uses OR logic to query all three datasets
  if (
    [
      COPERNICUS_CLMS_WSI_WATER_ICE_COVER_S1_EUROPE_UTM_60M_DAILY_V1,
      COPERNICUS_CLMS_WSI_WATER_ICE_COVER_S2_EUROPE_UTM_20M_DAILY_V1,
    ...
    return [
      {
        id: ODataCollections.CLMS_BIOGEOPHYSICAL_PARAMETERS.id,
        instrument: 'WATER_AND_ICE_COVER',
        productType: 'clms_wsi_water-ice-cover-search_group',
        selectedFilters: {},
      },
    ];
  }
  ...
  if (CCM_VHR_COLLECTIONS.includes(datasetId)) {
    return [
      {
  ...
  if ([CDAS_L8_L9_LOTL1].includes(datasetId)) {
    return [
      {
...
const createBasicSearchQuery = ({
  ...
  if (oDataCollectionInfo !== null) {
    collections = oDataCollectionInfo.map((collectionInfo) => ({
      id: collectionInfo.id,
      ...(collectionInfo.instrument
        ? {
            instruments: collectionInfo.instrument
              ? [
                  {
                    id: collectionInfo.instrument,
                    ...(collectionInfo.maxCC ? { cloudCover: collectionInfo.maxCC } : {}),
                    ...(collectionInfo.productType
                      ? { productTypes: [{ id: collectionInfo.productType }] }
                      : {}),
                  },
                ]
              : [],
        ...
        : {}),
      additionalFilters: collectionInfo.selectedFilters,
    }));
  }
