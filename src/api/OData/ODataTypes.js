...
const ODataProductTypeExtension = {
  AMH_ERRMAT: ODataProductFileExtension.EOF,
  AMH_ERRMAT_PRIVATE: ODataProductFileExtension.EOF,
  AMV_ERRMAT: ODataProductFileExtension.EOF,
  AMV_ERRMAT_PRIVATE: ODataProductFileExtension.EOF,
  AUX_GNSSRD: ODataProductFileExtension.TGZ,
  AUX_GNSSRD_PRIVATE: ODataProductFileExtension.TGZ,
  AUX_MOEORB: ODataProductFileExtension.EOF,
  AUX_MOEORB_PRIVATE: ODataProductFileExtension.EOF,
  AUX_POEORB: ODataProductFileExtension.EOF,
  AUX_POEORB_PRIVATE: ODataProductFileExtension.EOF,
  ...
  AUX_PROQUA_PRIVATE: ODataProductFileExtension.TGZ,
...
const ODataCollections = {
  ...
  CLMS_LAND_COVER_AND_LAND_USE_IN_PRIORITY_AREAS: {
    id: 'CLMS_LAND_COVER_AND_LAND_USE_IN_PRIORITY_AREAS',
  ...
  LANDSAT_MOSAIC_BI_MONTHLY: {
    id: 'landsat_mosaic',
    label: 'Landsat Mosaic (bi-monthly)',
